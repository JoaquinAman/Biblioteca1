...
public class Lamina_BotonesTarea extends JPanel{
	
	public Lamina_BotonesTarea(String titulo, String [] opciones) {
		...
		botonOpcion3 = new JRadioButton(opciones[3]);
		...
		botonOpcion3.setActionCommand(opciones[3]);
		...
		grupo.add(botonOpcion3);
	}
	
	public Lamina_BotonesTarea(String titulo) {
	...
	private JRadioButton botonOpcion3;
	...
	public JRadioButton getBotonOpcion3() {
		return botonOpcion3;
	}

	public void setBotonOpcion3(JRadioButton botonOpcion3) {
		this.botonOpcion3 = botonOpcion3;
	}
}
